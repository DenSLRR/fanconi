      ...
      <div className="footer__container">
        <div className="footer__links">
          <div className="footer__wrapper">
            ...
            <div className="footer__home">
              <ul>
                <li>
                  <a className="footer__links-item" href="#video">
                    Главная
                  </a>
                </li>
                <li>
                  <a className="footer__links-item" href="#gallery">
                    Фото
                  </a>
                </li>
                <li>
          ...
          <div className="footer__contacts">
            <a className="footer__contacts-number" href="tel:+373079808080">
              +373 79-808-080
            </a>
            ...
            <div className="footer__social">
              <a href="https://www.facebook.com/fanconi.riviera.summer.club/?locale=ru_RU">
                <FaFacebookSquare className="footer__social-item" />
              </a>
              <a href="https://www.tiktok.com/@fanconi_riviera">
                <AiFillTikTok className="footer__social-item" />
              </a>
              <a href="https://www.instagram.com/fanconi_riviera/">
        ...
        <div className="footer__address">
          <div className="footer__address-street">
            <a href="https://maps.app.goo.gl/bH8nJgodN47QWYU58">НАШ АДРЕС: УЛ ГИДИГИЧ 5, (НИАГАРА) </a>
          </div>
